 ...
 * Elitism in population, keeping 50% of best solutions at every generation */
    ...
    double CROSS_P = 0.7;
    int WORSE_ACCEPTANCE_PROB = 0; //Prob of accepting worse solutions in local optimization process
...
int main() {
    ...
    while (generation < MAX_GENERATIONS) {
        ...
        if(SET_CHROMOSOMES[0] >= best_solution && generation - last_mutation > 100 && generation - iter_best > 200 && mutation_type==1){ 
        ...
        }else if(SET_CHROMOSOMES[0] >= best_solution and generation - last_mutation > 100 && generation - iter_best > 200 && mutation_type==2){
    ...
    cout << endl << "With cost: " << calculate_cost(SOL, NUMBER_OBJECTS-1) << endl;    
}   